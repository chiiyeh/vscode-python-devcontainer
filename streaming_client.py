...
async def run(server_addr: str, server_port: int, test_wav: str):
    async with websockets.connect(
        ...
        sampling_rate = 16000
        full_audio = decode_audio(test_wav, sampling_rate=sampling_rate)
        #! Assuming this!
        sample_rate = 16000
        settings = {
            "temperature": 0,
